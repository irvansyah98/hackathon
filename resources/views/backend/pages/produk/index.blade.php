  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <a href="{{ url('/backend/produk/create') }}" class="btn btn-success pull-right">Create New</a>
            ...
            <tbody>
              @foreach($data as $item)
                <tr>
                  ...
                  <td width="150">
                    <form action="{{ url('backend/produk/'.$item->id) }}" method="post">
                      {{ csrf_field() }}
                      <input type="hidden" name="_method" value="DELETE">
                      <a href="{{ url('backend/produk/'.$item->id.'/edit') }}" class="btn btn-info"><i class="fa fa-pencil"></i> Edit</a>
